    ...
    *,
    ...
    Args:
        ...
        bit_array: Array of sampled bitstrings. Each bitstring should have both the
            ...
            ``[b_N, ..., b_0, a_N, ..., a_0]``. If the samples are in first quantisation, 
            then the bitstring should be a series of Q long bit registers where Q = ceil(log2(norb)), 
            with the first n_alpha of these registers encoding the occupied alpha orbitals 
            and the next n_beta registers encoding the occupied beta orbitals.
